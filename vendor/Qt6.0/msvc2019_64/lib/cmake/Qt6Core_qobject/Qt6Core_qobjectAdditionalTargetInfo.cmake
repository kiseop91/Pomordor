...
get_target_property(_qt_imported_location Qt6::Core_qobject IMPORTED_LOCATION_RELWITHDEBINFO)
get_target_property(_qt_imported_implib Qt6::Core_qobject IMPORTED_IMPLIB_RELWITHDEBINFO)
get_target_property(_qt_imported_soname Qt6::Core_qobject IMPORTED_SONAME_RELWITHDEBINFO)
...
if(_qt_imported_location)
    set_property(TARGET Qt6::Core_qobject PROPERTY IMPORTED_LOCATION_RELEASE "${_qt_imported_location}")
endif()
if(_qt_imported_implib)
    set_property(TARGET Qt6::Core_qobject PROPERTY IMPORTED_IMPLIB_RELEASE "${_qt_imported_implib}")
endif()
if(_qt_imported_soname)
    set_property(TARGET Qt6::Core_qobject PROPERTY IMPORTED_SONAME_RELEASE "${_qt_imported_soname}")
endif()
